...
<head>
    <title>Teaching Assistant Website by 5%</title>
        ...
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">
                    <img id="logo-header" src="img/logo1-default.png" alt="Logo">
                </a>
            </div>
            ...
            <div class="collapse navbar-collapse navbar-responsive-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="homework_teacher.html">Homework</a></li>
                            <li><a href="grades_student.html">Grades</a></li>
                            <li><a href="group_apply.html">Group</a></li>
                        </ul>
                    </li>
                    <!-- End Homework And Grades -->

                    <!-- Resourses -->
                    <li class="">
                        <a href="rescourse_list.php" class="dropdown-toggle" data-toggle="dropdown">
                            Rescourses
                        </a>
                    </li>
                    <!-- End Resourses -->
                    ...
                    <!-- Forum -->
                    <li class="">
                        <a href="forum_index.php" class="dropdown-toggle" data-toggle="dropdown">
                            Forum
                        </a>
                    </li>
                    <!-- End Forum -->
...
<div class="job-img margin-bottom-30">
    <div class="job-banner">
        <h2>Next Monday,Room 501</h2>
        <h2>Requirements change research!!!</h2>
    </div>
    <!--<div class="job-img-inputs">
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-4">
                    <button type="button" class="btn-u btn-block btn-u-dark">Login</button>
                </div>
            </div>
        </div>
    </div>-->
...
<div class="container content">
    <!-- Job Content -->
    <!--<div class="headline"><h1>Course Introduction</h1></div>
    <h3>Donec non turpis in erat iaculis pulvinar id ac magna. Proin sem urna, tincidunt ac hendrerit in, lobortis interdum nisi. Quisque ornare dui sodales, mattis dolor ac, pellentesque nisl. Suspendisse quam dolor, euismod sed massa vitae, placerat congue turpis. Nulla congue lectus nec tellus euismod, porta mattis nisl interdum. </h3>
    <ul class="list-unstyled">
        <li><h4><i class="color-green fa fa-check"></i> Nullam laoreet est sit amet felis tristique laoreet</h4></li>
        <li><h4><i class="color-green fa fa-check"></i> The biggest problem was unreasonable expectations from management</h4></li>
        <li><h4><i class="color-green fa fa-check"></i> Dealing with the customers was the other issue</h4></li>
    </ul>
</div>-->
    <!-- End Job Content -->
    <!-- Accordion v1 -->
    <div class="panel-group acc-v1" id="accordion-1">
        <div class="panel panel-default">
            ...
            <div id="collapse-One" class="panel-collapse collapse in">
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-8">
                            <p>description to this doc,including the aim,a brief introduction to the content and so on.</p>
                            <a>download</a>&nbsp;
                        </div>
                    </div>
                </div>
        ...
        <div class="panel panel-default">
            ...
            <div id="collapse-Three" class="panel-collapse collapse">
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-8">
                            <p>description to this ppt,including the aim,a brief introduction to the content and so on.</p>
                            <a>download</a>&nbsp;
                        </div>
                    </div>
                </div>
        ...
        <div class="panel panel-default">
            ...
            <div id="collapse-Five" class="panel-collapse collapse">
                <div class="panel-body">
                    <p>description to this pdf,including the aim,a brief introduction to the content and so on</p>
                    <a>download</a>&nbsp;
                </div>
            </div>
        </div>
...
<div class="parallax-team parallaxBg">
    <div class="container content">
        <div class="title-box-v2">
            <h2>Introduce Our <span class="color-green">Teacher</span> Here</h2>
    ...
    <div class="copyright">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <p>
                        2014 &copy; All Rights Reserved. Teaching Assistant Website By
                        <a target="#" href="https://twitter.com/htmlstream">5%</a> Terms of Service</a>
                    </p>
                </div>
                <!-- Social Links -->
                <div class="col-md-6">
